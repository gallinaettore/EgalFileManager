 ...
 */
public abstract class DatiFilesFtpBaseAdapter extends RecyclerView.Adapter<DatiFilesFtpBaseViewHolder> implements ListFilter.Filterable, MultiSelectable {
    ...
    private final List<FtpElement> selezionati;
    private List<FtpElement> backupListaCompleta;
     ...
     */
    DatiFilesFtpBaseAdapter(@NonNull Context context, OnItemTouchListener listener){
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull DatiFilesFtpBaseViewHolder holder, int position) {
     ...
     */
    @Override
    public void onBindViewHolder(@NonNull DatiFilesFtpBaseViewHolder viewHolder, int position, @NonNull List<Object> payloads) {
        if (payloads.isEmpty()) {
     ...
     */
    public boolean update(List<FtpElement> listaFiles){
        ...
        for(FtpElement file : listaFiles){
            ...
            Long valorePrecedente = dimensioniFiles.put(file.getAbsolutePath(), fileSize);
     ...
     */
    private boolean listaUguale(List<FtpElement> nuovaLista){
    ...
    /**
     * Restitusce gli elementi selezionati
     * @return Lista dei files selezionati
     */
    public List<FtpElement> getElementiSelezionati(){
     ...
     */
    public List<FtpElement> getListaFiles(){
    ...
    public interface OnItemTouchListener {
        void onItemClick(FtpElement file);
        void onItemLongClick(FtpElement file);
    }
}
