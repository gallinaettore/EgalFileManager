...
package it.Ettore.egalfilemanager.lan.netbios;
...
@SuppressWarnings({"AccessStaticViaInstance", "SameParameterValue", "WeakerAccess", "CanBeFinal", "UnnecessaryBoxing", "SynchronizationOnLocalVariableOrMethodParameter"})
class NameServiceClient implements Runnable {
    ...
    @SuppressWarnings({"ForLoopReplaceableByForEach", "StringEquality"})
